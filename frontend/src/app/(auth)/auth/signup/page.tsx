  ...
  return (
    <div className="space-y-6">
      <div className="space-y-1 text-center">
        <h1 className="text-3xl font-bold tracking-tight text-[#10283D]">Create account</h1>
        <p className="text-sm text-[#10283D]">Get started for free</p>
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        <div className="space-y-1.5">
          <label htmlFor="displayName" className="ml-2 text- font-medium text-[#10283D]">
            Name
          </label>
          <input
            id="displayName"
        ...
        <div className="space-y-1.5">
          <label htmlFor="confirmPassword" className="ml-2 text-base font-medium text-[#10283D]">
            Confirm password
          </label>
          <input
            id="confirmPassword"
        ...
        <button
          ...
          className="mx-auto block w-60 rounded-full bg-black border px-4 py-3 text-sm font-semibold text-white transition-colors transition-all hover:bg-zinc-800 hover:shadow-md active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-50"
        >
